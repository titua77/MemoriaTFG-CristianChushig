...
% http://texblog.org/2014/04/22/using-google-scholar-to-download-bibtex-citations/
 ...
 \begin{thebibliography}{1}
  ...
  \bibitem{notes} Django Project. {\em Página oficial del framework para el servidor} \url{www.djangoproject.com}

  \bibitem{impj}   {\em Imperial Japan 1800-1945} 1973:
  Random House, N.Y. {\url{getbootstrap.com}}

  \bibitem{norman} Grupo de Sistemas y Comunicaciones {\em Japan's emergence as a modern
