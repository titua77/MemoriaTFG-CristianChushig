...
computacional, y es el m�s importante desde el punto de vista de informaci�n relevante
...
Analiza el proyecto Scratch y asigna una puntuaci�n que cuantifica el grado de expertise
mostrado en la programaci�n para diferentes aspectos del pensamiento computacional: la
abtracci�n, paralelizaci�n, razonamiento l�gico, sincronizaci�n, control de flujo,
interactividad con el usuario y representaci�n de la informaci�n. Cada aspecto tiene
una puntuaci�n m�xima de 3, siendo 1 el nivel m�s b�sico y 3 un nivel m�s experto. En
total la suma de los 7 aspectos es 21. El plugin suma los valores obtenidos en cada 
aspecto del pensamiento computacional y en funci�n del resultado sacado asigna un
nivel de maestr�a para el proyecto analizado, siendo los niveles: b�sico, en desarrollo
y profesional.
...
proyecto. Todas las nociones b�sicas del desarrollo web, c�mo se procesan
las peticiones HTTP, la iniciaci�n en HTML y CSS para la parte Front End.
En SAT tambi�n aprend� a usar Django, la parte n�cleo con la que se 
...
en c�mo crear una aplicaci�n RESTful a trav�s de las funcionalidades de

Adem�s, debo mencionar otros conocimientos adquiridos por asignaturas como
Dise�o de Bases de Datos, Metodolog�a de la programaci�n y Estructura de 
Datos me han permitido tener una visi�n m�s global y abstracta a la hora
de establecer la l�gica y flujo del programa.
...
La lecci�n m�s importante es como trabajar con distintas tecnolog�as para
conseguir un objetivo com�n. El hecho de juntar diversos frameworks era
un reto, ya que se deb�an establecer las pautas para su comunicaci�n y 
que esta sea fiable y eficaz. En un principio, el mayor reto estaba en el
framwork Hairball, que era un poco desconocido, pero se logr� salir con
resultados positivos.

Otro de los puntos positivos fue aprendar de dise�o y maquetaci�n web. Dentro
de la carrera aprendimos como usar Django para desarrollar el servidor, 
procesar las peticiones y la inclusi�n de templates, pero esto centr�ndonos
en mayor medida en la parte de l�gica, sin meternos demasiado en la parte
de Front End. Con esto proyecto aprend� a usar Bootstrap y darle un matiz
m�s profesional a mis aplicaciones web, adem�s de poder crear aplicaciones
responsive que puedan ser abiertas sin p�rdida de estilo en cualquier
dispositivo m�vil. 

Por �ltimo quisiera se�alar un aspecto que nuevo y novedoso que me aport�
gran inter�s, el pensamiento computacional. La introducci�n de la 
programaci�n dentro de la ense�anza de los ni�os con el fin de adquirir
nuevas habilidades muy �tiles dentro del contexto actual. Descubr� que 
la programaci�n ayuda y tiene un impacto enorme en como evolucionan 
ciertas partes de nuestro cerebro, y aunque de estos matices todav�a
